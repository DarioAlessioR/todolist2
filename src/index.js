...
// Make activity field editable and save new content to array and localStorage
    activity.addEventListener('keydown', function(e) {
...
// Give the trash can icon the order to delete the i element on click. After deletenig, will save new array
//   and show new list of activities on screen 
...
// After updating the array, save it to localStorage and call showtodolist function to show new list on screen
    localStorage.setItem('texttodolist', JSON.stringify(todolist));
